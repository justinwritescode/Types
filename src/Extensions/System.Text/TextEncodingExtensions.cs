...
{
    /// <summary>Calls Encoding.UTF8.GetBytes(<paramref name="s"/>)</summary>
    ...
    /// <summary>Calls Encoding.Unicode.GetString(<paramref name="s"/>)</summary>
    /// <param name="bytes">The byte array to decode</param>
    ...
    /// <summary>Calls UTF7.Unicode.GetString(<paramref name="bytes"/>)</summary>
    /// <param name="bytes">The byte array to decode</param>
